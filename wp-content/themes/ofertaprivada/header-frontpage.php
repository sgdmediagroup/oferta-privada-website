...
<header class="masthead">
  <div class="inner container">
    ...
    <i id="toggle-menu" class="fa fa-bars d-block d-lg-none"></i>
    <nav id="nav-desktop" class="nav nav-masthead justify-content-center float-right d-none d-lg-block">
        <?php wp_nav_menu( array('menu' => 'principal' )); ?>
    </nav>
  </div>
</header>
<nav id="nav-mobile" class="bg-light nav nav-masthead justify-content-center text-center d-none d-lg-none w-100">
  <div class="inner container">
    <?php wp_nav_menu( array('menu' => 'principal' )); ?>
  </div>
</nav>
